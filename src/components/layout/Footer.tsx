        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/design" className="text-primary-foreground/70 hover:text-accent transition-colors">
                  Design
                </Link>
              </li>
              <li>
                <Link to="/interpret" className="text-primary-foreground/70 hover:text-accent transition-colors">
                  Interpret
                </Link>
              </li>
              <li>
